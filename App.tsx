...
const App: React.FC = () => {
        ...
        if (selectedProduct) {
            ...
            try {
                ...
                if (result.success && result.booking) {
                    ...
                    // The first codebase was missing this crucial step. Now it's here.
                    // Instead of navigating back, we'll let the render logic show the confirmation.
                    // We also refetch data to update the UI with new booking info.
                    refetchData(); 
                } else {
    ...
    const renderContent = () => {
        ...
        // --- START OF NEW/INTEGRATED CONFIRMATION LOGIC ---
        if (confirmedBooking) {
        ...
        // --- END OF NEW/INTEGRATED CONFIRMATION LOGIC ---
