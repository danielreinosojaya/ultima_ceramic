    ...
    if (product.type === 'OPEN_STUDIO_SUBSCRIPTION') {
      ...
      return (
        <>
          ...
          {/* Enlace secundario de WhatsApp para dudas */}
          <div className="mt-6 text-center">
            <a
              href="https://wa.me/593985813327?text=Hola%2C%20quiero%20más%20información%20sobre%20Open%20Studio"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-brand-secondary underline hover:text-brand-primary transition-colors"
            >
    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-end">
            ...
            >
                {product.type === 'OPEN_STUDIO_SUBSCRIPTION' ? 'Suscribirse y Pagar' : 'Confirmar'}
            </button>
        </div>
      </div>
    </div>
