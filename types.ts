...
// Products
export type ProductType = 'CLASS_PACKAGE' | 'OPEN_STUDIO_SUBSCRIPTION' | 'INTRODUCTORY_CLASS' | 'GROUP_EXPERIENCE' | 'COUPLES_EXPERIENCE' | 'SINGLE_CLASS' | 'GROUP_CLASS' | 'WHEEL_COURSE' | 'CUSTOM_EXPERIENCE' | 'CUSTOM_GROUP_EXPERIENCE' | 'SPACE_RENTAL';
