...
// ═══════════════════════════════════════════════════════════════
// SCRIPT: Enviar campaña a 60 primeros prospectos por engagement
// Filtro: Solo @gmail.com y @hotmail.com
// ═══════════════════════════════════════════════════════════════
...
async function getTopProspectsFiltered(limit: number) {
    const safeLimit = Math.max(1, Math.min(300, Math.floor(limit || 60)));

    console.log(`📊 Extrayendo top ${safeLimit} prospectos (solo @gmail.com y @hotmail.com)...\n`);
...
async function main() {
    console.log('═══════════════════════════════════════════════════════════════');
    console.log('  Campaña San Valentín - 60 Primeros Prospectos');
    console.log('═══════════════════════════════════════════════════════════════\n');

    try {
        const prospects = await getTopProspectsFiltered(60);
        ...
        if (sent > 0) {
            ...
            console.log(`📧 Próxima acción: Los clientes verán el mensaje actualizado sobre cierre a las 9 PM\n`);
        } else {
            console.log('❌ No se envió ningún email. Revisar configuración.\n');
        }
