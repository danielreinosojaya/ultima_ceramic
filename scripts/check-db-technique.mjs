 ...
 * Run with: node scripts/check-db-technique.mjs
 */
...
async function checkInconsistentBookings() {
  ...
  try {
    ...
    console.log('-'.repeat(70));
    console.log('📋 Query 3 Alfarero": "Torno products with wrong technique...\n');
