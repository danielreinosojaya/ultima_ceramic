...
const ALIANZA_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; font-family: 'Poppins', Arial, sans-serif; background: #f9f7f3;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f9f7f3" style="border-collapse: collapse;">
        <tr>
                ...
                <table width="480" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="border-collapse: collapse; width: 480px; margin: 0 auto;">
                    <tr>
                        <td width="100%" style="background: linear-gradient(135deg, #c99a6e 0%, #a0674d 100%); padding: 32px 20px; text-align: center;">
                            ...
                            <h1 style="font-size: 32px; font-weight: 700; color: white; margin: 0 0 8px 0; line-height: 1.2;">Alianza CERAMICALMA</h1>
                    ...
                    <tr>
                        <td width="100%" style="padding: 32px 20px; color: #6b4423;">
                            <p style="font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;"><strong>Estimado/a,</strong><br>Creemos que las mejores alianzas nacen cuando compartimos valores: bienestar, autenticidad y conexión genuina.</p>
                            <p style="font-size: 16px; line-height: 1.6; color: #6b4423; margin: 0 0 28px 0;">Por eso hoy te invitamos a conocer <strong>Alianza CERAMICALMA</strong>: acceso exclusivo a un espacio premium donde cerámica, café y creatividad se transforman en experiencias que impactan realmente a tu equipo.</p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, rgba(201, 154, 110, 0.08) 0%, rgba(160, 103, 77, 0.04) 100%); border-left: 4px solid #a0674d; margin: 28px 0; border-collapse: collapse;">
                                <tr>
                                    <td style="padding: 24px 20px; text-align: center;">
                                        ...
                                        <p style="font-size: 40px; font-weight: 700; color: #6b4423; margin: 16px 0;">$3,800</p>
                            ...
                            <p style="font-size: 32px; font-weight: 700; color: #6b4423; margin: 0 0 6px 0;">USD 3,500 + IVA</p>
                    ...
                    <tr>
                        <td width="480" style="background: linear-gradient(135deg, #faf8f5 0%, #f5f2ed 100%); padding: 20px 20px; text-align: center; border-top: 1px solid rgba(160, 103, 77, 0.1);">
                            <p style="font-size: 16px; font-weight: 700; color: #6b4423; margin: 0 0 6px 0;">CERAMICALMA</p>
...
export default async (req: VercelRequest, res: VercelResponse) => {
  ...
  try {
    ...
    const htmlContent = html || ALIANZA_EMAIL_TEMPLATE;
